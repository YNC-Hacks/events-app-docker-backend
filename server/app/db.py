...
db_server_port = urllib.parse.quote_plus(str(os.environ.get('db_server_port', '5433')))
database_name = os.environ.get('database_name', 'ynchacks')
db_username = urllib.parse.quote_plus(str(os.environ.get('db_username', 'ynchacks')))
...
users = sqlalchemy.Table(
    "users",
    metadata,
    sqlalchemy.Column("user_email", sqlalchemy.String, primary_key=True),
