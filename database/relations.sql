...
ALTER TABLE "memberships" ADD FOREIGN KEY ("organization_id") REFERENCES "organization" ("organization_id");
...
ALTER TABLE "events" ADD FOREIGN KEY ("organization_id") REFERENCES "organization" ("organization_id");
